...
const EditorPanel = ({
  ...
  const [values, setValues] = useState<EditorPanelProps['selectedElement']>(null)
  ...
  const handleStyleChange = (styleName: string, value: string) => {
    ...
    const newValues = { ...values, style: newStyles }
    setValues(newValues)
    ...
    <div className="absolute top-4 right-4 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 z-50 animate-fade-in fade-in ">
      ...
      <div className="space-y-3 text-black">
        ...
        <div className="grid grid-cols-2 gap-3">
            ...
            />
            <span className='text-xs text-gray-600 truncate'>{values.style.backgroundColor}</span>
            </div>
          ...
          <div>
            ...
            <div className='flex items-center gap-2 border border-gray-400 rounded-md p-1'>
              ...
              className="w-6 h-6  cursor-pointer "
            />
            <span className='text-xs text-gray-600 truncate'>{values.style.color}</span>
            </div>
