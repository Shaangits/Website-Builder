...
const steps = [
    {
        icons : ScanLineIcon,label : "Analyzing your request..."
    },
     {
        icons : SquareIcon,label : "Generating layout structure..."
    },
     {
        icons : TriangleIcon,label : "Assembling UI components..."
    },
     {
        icons : CircleIcon,label : "Finalizing your website..."
    }
]
...
const LoaderSteps = () => {
    ...
    const Icon = steps[current].icons
  return (
