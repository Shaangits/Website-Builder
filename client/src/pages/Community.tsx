...
const Community = () => {
  ...
  // ⭐ build safe preview thumbnail using Blob (no srcDoc errors)
const buildPreviewBlob = (html: string) => {
  if (!html) return ""
  ...
  <iframe
    src={buildPreviewBlob(project.current_code)}
    ...
    <div className='p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors'>
      ...
      <div className='flex justify-between items-center mt-6'>
           ...
           <div className='flex gap-3 text-white text-sm '>
                 <button  className='px-3 py-1.5 bg-white/10 hover:bg-white/15 rounded-md    transition-colors flex items-center gap-2'><span className='bg-gray-200 size-4.5 rounded-full text-black font-semibold flex items-center justify-center'>
